...
SharePoint, SharePoint Requirements (IE), Project Requirements (features), old solution, rebuilding with angular because of new features and same cost of developing a new application and not building on sharepoint feature (also extensibility and encapsulation)
\clearpage
...
state, store, action, reducer, selector, effects
...
\subsection{Communication between Angular and SharePoint}
pnpjs, "REST" API, JSOM, CSOM, own backend in sharepoint

\subsection{Tooling}
polyfills, vendor, minifying
